      ...
      <div>
        <Dropdown overlayClassName="user-options" placement="topRight">
          ...
          <Menu slot="overlay" @click="handleUserMenuClick">
            <MenuItem key="user.edit">
              <router-link to>
                <Icon type="user" style="margin-right:5px;" />修改资料
              </router-link>
            </MenuItem>
            <MenuItem key="user.pass">
              <router-link to>
                <Icon type="setting" style="margin-right:5px;" />修改密码
              </router-link>
            </MenuItem>
            <MenuDivider />
            <MenuItem key="user.logout">
              <a href="javascript:;">
                <Icon type="poweroff" style="margin-right:5px;" />退出登录
              </a>
            </MenuItem>
          </Menu>
        </Dropdown>
